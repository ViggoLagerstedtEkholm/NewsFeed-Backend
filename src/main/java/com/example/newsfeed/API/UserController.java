...
import com.example.newsfeed.Helpers.FilterHelper;
import com.example.newsfeed.Helpers.JWTHelper;
import com.example.newsfeed.Models.DTO.*;
...
public class UserController{
    ...
    private List<UserResponse> getUserResponse(List<User> users){
        ...
        for (User user: users) {
            userResponses.add(new UserResponse(user.getUsername(), user.getFirstname(), user.getLastname(), user.getId()));
        }
    ...
    public ResponseEntity<User> registerUser(Register register){
        ...
        if(existingUserCheckUsername == null && existingUserCheckEmail == null){
            ...
            registerUser.setFirstname(register.getFirstname());
            registerUser.setLastname(register.getLastname());
